...
class Preload extends Phaser.State {
	...
	preload() {
		...
		this.game.load.tilemap('level1', require("file?name=[path][name].[ext]!./../objects/map/mape.json"), null, Phaser.Tilemap.TILED_JSON);
		this.game.load.spritesheet('map', require("file?name=[path][name].[ext]!./../objects/map/map.png"),15,15);
